...
public class ArchiveController {
    ...
    public CustomResponse<Archive> getTest() {
        ...
        return new CustomResponse<>(HttpStatus.OK.value(), "sucess",null, archive);
    }


    @GetMapping(value = "/test2")
    public ResponseEntity<?> getTest2() {
        return new ResponseEntity<>(new CustomResponse<>(HttpStatus.OK.value(), "sucess",null,null), HttpStatus.ACCEPTED);
    }
